...
READIDS=../nonRedundantReads.3.txt
...
cat mm2.paf | awk '{if ($3 == 0 && $2 == $4 && $2 == $10) print $6"\t"$8"\t"$9}' | sort -k 1,1 -k2,2n -k3,3nr >  mm2.exactmapped.bed
bedtools subtract -A -a $GAPS -b mm2.exactmapped.bed > unresolved_gaps.bed
